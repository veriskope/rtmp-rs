 ...
 * modified for use as internal library
...
/// Internal Struct that handles the handshaking process.
///
...
/// disconnect us after receiving our p2 packet, that the handshake was successful.  This has
...
mod tests {
  ...
  fn hmac_test() {
    ...
    let expected = [
      176_u8, 52_u8, 76_u8, 97_u8, 216_u8, 219_u8, 56_u8, 83_u8, 92_u8, 168_u8, 175_u8, 206_u8,
      175_u8, 11_u8, 241_u8, 43_u8, 136_u8, 29_u8, 194_u8, 0_u8, 201_u8, 131_u8, 61_u8, 167_u8,
